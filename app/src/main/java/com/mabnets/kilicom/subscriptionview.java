 ...
 */
public class subscriptionview extends Fragment {
    private CardView cdpayment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View py= inflater.inflate(R.layout.fragment_subscriptionview, container, false);
        cdpayment=(CardView)py.findViewById(R.id.cvpaystatus);
        paymentstatus=(TextView)py.findViewById(R.id.pstatus);
        paymentfee=(TextView)py.findViewById(R.id.subpayment);
        prcd=(Button)py.findViewById(R.id.procedbtn);
        rvp=(RecyclerView)py.findViewById(R.id.rvpyments);
            ...
            public void onResponse(String response) {
                ...
                if(!response.isEmpty()){
                    if(response.contains("None")){
                        ...
                        Log.d(Tag, response);
                        ArrayList<subdata> slist= new JsonConverter<subdata>().toArrayList(response, subdata.class);
                        subscriptionadapter subscriptionadapter=new subscriptionadapter(getContext(),slist);
                        rvp.setAdapter(subscriptionadapter);
    ...
    private void checkstatus(){
        ...
        StringRequest request=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.d(Tag,response);
                if(!response.isEmpty()){
                    if(response.contains("Depleted")){
                        cdpayment.setCardBackgroundColor(Color.RED);
                        paymentstatus.setText(response);
                    } else if(response.contains("Not Paid")) {
                        paymentstatus.setText(response);
                    } else{
                        paymentstatus.setText(response);
                    }
