...
public class hometwo extends Fragment {
    ...
    View hm= inflater.inflate(R.layout.fragment_hometwo, container, false);
        rcategories=(MultiSnapRecyclerView)hm.findViewById(R.id.rvcategoriescu);
        subrcategories=(MultiSnapRecyclerView)hm.findViewById(R.id.rvsubcategorizcu);
        rfmarkets=(MultiSnapRecyclerView)hm.findViewById(R.id.rvfeaturedmarketscu);
            ...
            public void onResponse(String response) {
                ...
                if(!response.isEmpty()){
                    if(response.contains("none")){
                        Toast.makeText(getContext(), "no markets existed", Toast.LENGTH_SHORT).show();
                    } else {
                        Log.d(Tag, response);
                        ArrayList<fmarkets> flist= new JsonConverter<fmarkets>().toArrayList(response, fmarkets.class);
                        featuredmarketsadapter featuredmarketsadapte=new featuredmarketsadapter(getContext(),flist,"5");
            ...
            public void onResponse(String response) {
                ...
                if(!response.isEmpty()){
                    if(response.contains("None")){
                        ...
                        Categoryadapter categoryadapter=new Categoryadapter(getContext(),categorylist,hometwo.this,"5");
            ...
            public void onResponse(String response) {
                ...
                if(!response.isEmpty()){
                    if(response.contains("None")){
                        ...
                        Subcategoryadapter scategoryadapter=new Subcategoryadapter(getContext(),scategorylist,"5");
